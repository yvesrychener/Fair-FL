...
if __name__ == '__main__':
    ...
    for l in ls:
        for seed in range(args.numSeeds):
            ...
            np.random.seed(seed)
            trainer = train.Trainer(datasets.SyntheticDataset(10,200,10).generate_data(), buildModelClass(11), torch.nn.BCEWithLogitsLoss(), N_epochs=args.numEpochs, lambda_=l, datasetname='Synthetic200')
            trainer.train()
